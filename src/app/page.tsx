                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-3 mb-6 md:mb-8">
                   ...
                   <div className="relative bg-[#050505] border-2 border-primary/30 p-6 md:p-10 overflow-hidden">
                    ...
                    <a
                      ...
                      className="block"
                    >
                      <Button className="w-full h-auto min-h-[4rem] md:h-20 text-sm md:text-xl font-black uppercase italic tracking-wider bg-gradient-to-br from-primary to-secondary hover:shadow-[0_0_40px_rgba(255,123,41,0.6)] transition-all text-white border-0 hover:scale-[1.02] mb-4 animate-cta-pulse py-4 md:py-0 leading-tight">
